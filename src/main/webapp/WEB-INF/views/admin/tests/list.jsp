    ...
    <div class="main-content-inner">
        <div class="breadcrumbs" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Test Management</li>
            </ul>
        </div>
            ...
            <div class="col-xs-12">
                <div class="widget-box">
                    <div class="widget-header">
                        <h4 class="widget-title">Tìm kiếm đề thi</h4>
                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            <form:form modelAttribute="modelSearch" action="/admin/test-list" method="GET"
                                       class="form-horizontal" id="listForm">
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <div class="col-xs-6">
                                            <label for="name">Tên đề thi</label>
                                            <form:input path="name" class="form-control" placeholder="Nhập tên đề thi"/>
                                        </div>
                                        <div class="col-xs-6">
                ...
                <div class="pull-right">
                    <a href="/admin/test-create">
                        <button class="btn btn-app btn-primary btn-sm">
                            <i class="fa fa-plus" aria-hidden="true"></i> Tạo đề thi
                        </button>
                    </a>
                </div>
            </div>
            ...
            <div class="col-xs-12">
                <div class="table-responsive">
                    <display:table name="model.listResult" cellspacing="0" cellpadding="0"
                        ...
                        <display:column property="name" title="Tên đề thi" headerClass="text-left"/>
                        ...
                        <display:column title="Thao tác" headerClass="text-left">
                            <div class="hidden-sm hidden-xs btn-group">
                                <a href="/admin/test-edit-${tableList.id}">
                                    <button class="btn btn-xs btn-info" title="Sửa đề thi">
                                        <i class="fa fa-pencil"></i>
                                    </button>
                                </a>
                                <button class="btn btn-xs btn-danger" onclick="deleteTest(${tableList.id})"
                                        title="Xóa đề thi">
