...
<div id="navbar" class="navbar navbar-expand-lg custom-navbar">
        ...
        <div class="navbar-buttons navbar-header pull-right" role="navigation">
            <ul class="nav ace-nav">
                <li class="light-10">
                    ...
                    <ul class="user-menu dropdown-menu-right custom-dropdown-menu dropdown-menu dropdown-caret dropdown-close">
                        <li>
